...
function clearListeners() {
  ...
  document
    .getElementById("allDataButton")
    .removeEventListener("click", startAllCleaner);
  document
    .getElementById("historyButton")
    .removeEventListener("click", startHistoryCleaner);
  document
    .getElementById("cookieButton")
    .removeEventListener("click", startCookiesCleaner);
  document
    .getElementById("localStorageButton")
    .removeEventListener("click", startLocalStorageCleaner);
  document
    .getElementById("cacheButton")
    .removeEventListener("click", startCacheCleaner);
  document
    .getElementById("indexedDbButton")
    .removeEventListener("click", startIndexedDbCleaner);
...
function init() {
  ...
  document
    .getElementById("allDataButton")
    .addEventListener("click", startAllCleaner);
  document
    .getElementById("historyButton")
    .addEventListener("click", startHistoryCleaner);
  document
    .getElementById("cookieButton")
    .addEventListener("click", startCookiesCleaner);
  document
    .getElementById("localStorageButton")
    .addEventListener("click", startLocalStorageCleaner);
  document
    .getElementById("cacheButton")
    .addEventListener("click", startCacheCleaner);
  document
    .getElementById("indexedDbButton")
    .addEventListener("click", startIndexedDbCleaner);
}
